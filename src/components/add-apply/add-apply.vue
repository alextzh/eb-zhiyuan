      ...
      <div class="content">
        ...
        <div class="item_body">
          ...
          <div class="item__right" style="text-align:right;">
            ...
            <span class="all_data" style='flex:0 auto;color: #652D92;' v-if="currentProduct.sub_status === 'DSH'">{{$t('apointRecord.pendingReview')}}</span>
            <span class="all_data" style='flex:0 auto;color: #09B3CD;' v-if="currentProduct.sub_status === 'SHTG'">{{$t('apointRecord.reviewPassed')}}</span>
            <span class="all_data" style='flex:0 auto;color: #EB1C22;' v-if="currentProduct.sub_status === 'SHJJ'">{{$t('apointRecord.reviewReject')}}</span>
            <span class="all_data" style='flex:0 auto;color: #92278F;' v-if="currentProduct.sub_status === 'ZJDSH'">{{$t('apointRecord.addPendingReview')}}</span>
            <span class="all_data" style='flex:0 auto;color: #41123C;' v-if="currentProduct.sub_status === 'XGDSH'">{{$t('apointRecord.modifyPendingReview')}}</span>
            <span class="all_data" style='flex:0 auto;color: #262163;' v-if="currentProduct.sub_status === 'SHSHZ'">{{$t('apointRecord.redeemPendingReview')}}</span>
            <span class="all_data" style='flex:0 auto;color: #2E3094;' v-if="currentProduct.sub_status === 'YSH'">{{$t('apointRecord.redeemed')}}</span>
          </div>
        </div>
