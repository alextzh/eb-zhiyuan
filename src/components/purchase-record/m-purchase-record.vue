...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created() {
      ...
      this.loading.show()
      this.pageData.customer_id = parent.localStorage.getItem('zyId') // parent.localStorage.getItem('zyId')
    },
    mounted() {
      setTimeout(() => {
    ...
    methods: {
      ...
      redeemAction(e) {
        ...
        if (this.$i18n.locale === 'zh') {
          parent.window.location.href = parent.path + '/common/m-redeem.html'
        } else if (this.$i18n.locale === 'tw') {
          parent.window.location.href = parent.path + '/common/m-ft-redeem.html'
        } else if (this.$i18n.locale === 'en') {
          parent.window.location.href = parent.path + '/common/m-en-redeem.html'
        }
      },
      // 追加份额
      addAction(e) {
        setProduct(e)
        if (this.$i18n.locale === 'zh') {
          parent.window.location.href = parent.path + '/common/m-addApply.html'
        } else if (this.$i18n.locale === 'tw') {
          parent.window.location.href = parent.path + '/common/m-ft-addApply.html'
        } else if (this.$i18n.locale === 'en') {
          parent.window.location.href = parent.path + '/common/m-en-addApply.html'
        }
      }
    }
  }
