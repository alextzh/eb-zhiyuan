    ...
    methods: {
      ...
      modifyAction(e) {
        ...
        if (this.$i18n.locale === 'zh') {
          parent.window.location.href = parent.path + '/common/m-modifyPlan.html'
        } else if (this.$i18n.locale === 'tw') {
          parent.window.location.href = parent.path + '/common/m-ft-modifyPlan.html'
        } else if (this.$i18n.locale === 'en') {
          parent.window.location.href = parent.path + '/common/m-en-modifyPlan.html'
        }
      },
      cancelAction(e) {
